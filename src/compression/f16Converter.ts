 ...
 * @returns {number}
 */
function roundTiesToEven(num: number): number {
 ...
 */
export function roundToFloat16(num: number): number {
	const number = +num;
 ...
 */
export function roundToFloat16Bits(num: number): number {
 ...
 */
export function convertToNumber(float16bits: number): number {
